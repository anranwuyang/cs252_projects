...
{
       0,    58,    58,    62,    63,    67,    70,    81,    84,    88,
      91,    97,    98,   102,   109,   110,   114,   122,   128,   143,
     144,   148,   158,   168,   178,   188,   199
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "STRING", "SUBSHELL", "NOTOKEN",
  "GREAT", "NEWLINE", "PIPE", "AMPERSAND", "GREATGREAT", "LESS",
  "GREATAMPERSAND", "GREATGREATAMPERSAND", "TWOGREAT", "END_OF_FILE",
  "$accept", "goal", "commands", "command", "background_opt", "pipe_list",
  "command_and_args", "argument_list", "argument", "command_word",
  "iomodifiers", "iomodifier", YY_NULLPTR
};
#endif
...
{
      10,    -5,    -8,    -8,    -8,    14,     9,    -8,    11,    -8,
      -8,    -8,    -8,    16,    -7,    -2,    11,    18,    19,    20,
      21,    22,    23,    17,    -7,    -8,    -8,    -8,    -8,    -8,
      -8,    -8,    -8,    -8,    -8,    -8,    24,    -8,    -8
};
...
{
       0,     0,    18,     5,     7,     0,     0,     3,    12,    15,
       8,     1,     4,     0,    20,    13,    12,     0,     0,     0,
       0,     0,     0,    10,    20,    16,    17,    14,    11,    21,
      23,    26,    24,    25,    22,     9,     0,    19,     6
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
      -8,    -8,    -8,    25,    -8,    12,    26,    -8,    -8,    -8,
       5,    -8
};
...
{
      17,    25,    26,    10,    18,    19,    20,    21,    22,    -2,
       1,     1,     2,     2,    11,     3,     3,     4,     4,     2,
      13,    29,    30,    31,    32,    33,    34,    35,    28,    37,
       0,    12,    38,     0,     0,     0,     0,     0,     0,    16
};

static const yytype_int8 yycheck[] =
{
       7,     3,     4,     8,    11,    12,    13,    14,    15,     0,
       1,     1,     3,     3,     0,     6,     6,     8,     8,     3,
       9,     3,     3,     3,     3,     3,     3,    10,    16,    24,
      -1,     6,     8,    -1,    -1,    -1,    -1,    -1,    -1,    13
};
...
{
       0,     1,     3,     6,     8,    18,    19,    20,    23,    26,
       8,     0,    20,     9,    22,    24,    23,     7,    11,    12,
      13,    14,    15,    27,    28,     3,     4,    25,    22,     3,
       3,     3,     3,     3,     3,    10,    21,    27,     8
};
...
#line 114 "shell.y" /* yacc.c:1646  */
    ...
    if(*(yyvsp[0].string_val) != '\0'){
      expandWildCards((yyvsp[0].string_val));
